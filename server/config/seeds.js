  ...
  const products = await Product.insertMany([
    {
      ...
      category: [categories[0]._id, categories[2]._id, categories[7]._id],
      price: 44.99,
      quantity: 50,
    },
    {
      ...
      category: [categories[0]._id, categories[7]._id],
      price: 29.99,
      quantity: 500,
    },
    {
    ...
    },
    {
      ...
      category: [categories[2]._id, categories[7]._id],
      description:
    ...
    },
    {
      ...
      category: [categories[2]._id, categories[6]._id, categories[7]._id],
      description:
    ...
    {
      name: "The Ring",
      category: [categories[3]._id, categories[7]._id],
      description:
    ...
    {
      name: "Aliens",
      category: [categories[1]._id, categories[4]._id, categories[7]._id],
      description:
    ...
    {
      name: "Arrival",
      category: [categories[0]._id, categories[4]._id, categories[7]._id],
      description:
    ...
    {
      name: "Home Alone",
      category: [categories[2]._id, categories[5]._id, categories[7]._id],
      description:
    ...
    {
      name: "Before Sunset",
      category: [categories[0]._id, categories[6]._id, categories[7]._id],
      description:
