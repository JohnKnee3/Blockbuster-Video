  ...
  const renderEditForm = (currentCommentId, currentCommentText) => {
    ...
    return (
      <div>
        ...
        <form>
          <textarea required name="updatedCommentText" onChange={handleChange}>
            {currentText}
          </textarea>
          <button
            id="submit"
            type="submit"
            onClick={() => handleUpdateComment(currentId)}
          >
            Done
          </button>
        </form>
      ...
      <div>
        {comments &&
          comments.map((comment) => (
            ...
            // console.log("I am coments.username", comments.username),
